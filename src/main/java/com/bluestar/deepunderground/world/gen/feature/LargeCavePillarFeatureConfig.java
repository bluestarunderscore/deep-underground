...
public class LargeCavePillarFeatureConfig implements FeatureConfig
{
    public static final Codec<LargeCavePillarFeatureConfig> CODEC = RecordCodecBuilder.create(
            instance -> instance.group(
                    ...
                    .apply(instance, LargeCavePillarFeatureConfig::new)
    );
    ...
    public LargeCavePillarFeatureConfig(
